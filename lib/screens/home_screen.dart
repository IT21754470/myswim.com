...
class _HomeScreenState extends State<HomeScreen> {
  ...
  onTap: () async {
    ...
    if (result == true) {
      _refreshStats(); // will run because screen calls Navigator.pop(context, true)
    }
  },
),
                ],
...
Widget _buildFeatureCard({
  ...
  final bool isEnabled = sessionCount > 0 || title == 'Swimmer Insights' || title == 'Injury Risk Prediction';
  final bool showRequirement = !isEnabled && title != 'Swimmer Insights' && title != 'Injury Risk Prediction';
